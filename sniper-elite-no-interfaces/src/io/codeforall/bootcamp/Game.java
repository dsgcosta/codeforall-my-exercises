...
public class Game {
    ...
    public void start() {
        ...
        for (GameObject gameObject : gameObjects) {
            ...
            if (gameObject instanceof Destroyable) {// if(gameObject instance of Enemy)

                Destroyable target = (Destroyable) gameObject; //Enemy target = (Enemy) gameObject;
                //Enemy targets = (Enemy) gameObject;
    ...
    private GameObject[] createGameObjects(int numberObjects) {
        ...
        for (int i = 0; i <gameObjects.length ; i++) {
            ...
            }else gameObjects[i] =  GameObjectFactory.createEnemy();
